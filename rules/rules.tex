...
Each player brings the same number of Frames, and a 20 card deck for that suit. Deckbuilding rules to be added later (think weapon slots etc) but default decks exist. 
...
To construct a deck, you first choose the frame (the model of frame used).
