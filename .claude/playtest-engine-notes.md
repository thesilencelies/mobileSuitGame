...
Root `CLAUDE.md` covers the card/TTS build pipeline. This covers the engine.
...
```bash
~/venv/default_env/bin/python -m pytest playtest/tests -q     # ~665 tests
~/venv/default_env/bin/python -m playtest.ai.arena            # AI still plays
