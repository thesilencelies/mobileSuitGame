---
name: playtest-engine
description: >-
  Architecture guidelines, rules rulings, test traps, and verification requirements for the phone-playable game engine in playtest/. Use when modifying card effects, resolving actions or combat, handling hidden information or board line-of-sight, writing engine tests, or running the engine verification stack.
---
